(() => {
  document.addEventListener('DOMContentLoaded', async () => {  // ← made callback async
    ...
    let isPremiumUser = false;    // Start as false until checked
    let premiumShown = false;     // Start as false so popup can show if free user
    let replyCount = 0;
    ...
    async function checkLimit() {  
      ...
      isPremiumUser = isWhitelisted;  // update premium status fresh every time too
